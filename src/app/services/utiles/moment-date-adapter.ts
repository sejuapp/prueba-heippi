...
export class MomentDateAdapter extends DateAdapter<Moment> {
  ...
  setLocale(locale: string) {
    ...
    this._localeData = {
      ...
      longMonths: this.MONTHS.long /*momentLocaleData.months()*/,
      narroMonths: this.MONTHS.narrow,
      shortMonths: this.MONTHS.short /*momentLocaleData.monthsShort()*/,
      dates: range(31, (i) => this.createDate(2017, 0, i + 1).format('D')),
      longDaysOfWeek: this.DAYS.long /*momentLocaleData.weekdays()*/,
      shortDaysOfWeek: this.DAYS.short /*momentLocaleData.weekdaysShort()*/,
      narrowDaysOfWeek: this.DAYS.narrow /*momentLocaleData.weekdaysMin()*/,
    };
  }
